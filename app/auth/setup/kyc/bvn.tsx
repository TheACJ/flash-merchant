...
export default function BVNVerification() {
  ...
  const handleNext = () => {
    if (digits.length === MAX_DIGITS) {
      ...
      router.push({
        pathname: './verifying',
        params: { type: 'BVN', number: displayValue },
      });
    }
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>BVN</Text>
          <View style={{ width: 50 }} />
        </View>

        {/* Input Section */}
        <View style={styles.inputSection}>
          <Text style={styles.inputLabel}>Enter your BVN number</Text>
